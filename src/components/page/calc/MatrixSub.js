...
export default function MatrixSub() {
    ...
    const handlemChange = (e) => {
        ...
        setResult(makeMatrix(e.target.value, n));
    }
    ...
    const handlenChange = (e) => {
        ...
        setResult(makeMatrix(m, e.target.value));
    }
...
<h1 className="text-center">Matrix Subtraction</h1>
            <div className="item">
                ...
                <div className="matrix_display">
                    ...
                    <div className="matrix_button">
                        <button className='btn btn-success' onClick={handleSub}>Enter</button>
